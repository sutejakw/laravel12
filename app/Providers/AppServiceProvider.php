...
use App\Repositories\Permission\Impl\PermissionRepositoryImpl;
...
use App\Services\Permission\Impl\PermissionServiceImpl;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(IPermissionService::class, PermissionServiceImpl::class);
        $this->app->bind(IPermissionRepository::class, PermissionRepositoryImpl::class);
    }
