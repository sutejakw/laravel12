...
const PaginationLink = ({ href, srText, icon: Icon, hiddenOnMd }) => (
    <Link
        ...
        preserveState
        href={href}
        className={`h-8 w-8 p-0 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 border border-gray-200 bg-background shadow-sm  ${hiddenOnMd ? 'hidden md:inline-flex' : ''}`}
    >
